...
if needed_in_et > 100:
    ...
    # --- HELP! AM I GOING TO FAIL? (Safety Buffer) ---
# This part checks the absolute minimum I need just to pass the course (50 total)

print("\n--- 🛡️ THE 'SAVE ME' ANALYSIS ---")

pass_mark = 50.0  # VIT passing threshold
needed_to_pass = (pass_mark - current_total) / 0.3

if current_total >= 50:
    print("Good news: You have already passed the course!")
    print("Even if you get a 0 in the End-Term, you're safe.")
elif needed_to_pass > 100:
    print("Warning: Even with 100/100 in the End-Term, you might not hit 50 total.")
    print("You should talk to the professor about extra credit.")
else:
    print(f"To just 'Pass' this course (50 total), you only need {needed_to_pass:.2f} marks.")
    print("That's your 'Safety Buffer'. Don't score less than this!")